...
{
    public static IQueryable<Library> WhereUserIs(this IQueryable<Library> query, string userId)
    {
        return query.Where(l => l.UserId == userId);
    }

    public static IQueryable<Library> WhereTypeIs(this IQueryable<Library> query, LibraryType type)
    {
